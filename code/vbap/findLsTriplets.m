...
[mesh.vert(:,1), mesh.vert(:,2), mesh.vert(:,3)] = sph2cart(ls_dirs_rad(:,1), ls_dirs_rad(:,2), 1);%球坐标转化为笛卡尔坐标(直角坐标)
mesh.faces = sphDelaunayTriangulation(ls_dirs_rad);

% discard invalid faces, and omit large triangles if asked   丢弃不合法的三角形
